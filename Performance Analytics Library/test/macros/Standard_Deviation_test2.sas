%macro Standard_Deviation_test2(keep=FALSE);
%global pass notes;
...
%end;
%else %do;
	filename x "&dir\Standard_Deviation_test2_submit.sas";
%end;
...
%Standard_Deviation(prices, outStdDev= annualized_stddev)
