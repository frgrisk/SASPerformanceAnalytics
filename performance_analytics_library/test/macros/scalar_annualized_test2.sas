...
put "                 )";
put "		)";
put "results = na.omit(Return.calculate(prices[1:101,1], method='log'))";
put "scale_4 = apply.daily(results/4,FUN=Return.annualized,geometric=FALSE,scale=4)";
put "scale_12 = apply.daily(results/12,FUN=Return.annualized,geometric=FALSE,scale=12)";
put "scale_52 = apply.daily(results/52,FUN=Return.annualized,geometric=FALSE,scale=52)";
put "scale_252 = apply.daily(results/252,FUN=Return.annualized,geometric=FALSE,scale=252)";
