/*---------------------------------------------------------------
* NAME: Drawdown_Deviation.sas
*
* PURPOSE: Calculates a standard deviation-type statistic using individual drawdowns.
*
* NOTES: 
*
* MACRO OPTIONS:
...
* outData - Optional. Output Data Set with drawdown deviation.  Default="DD_dev".
*
* MODIFIED:
* 6/3/2016 – QY - Initial Creation
*
* Copyright (c) 2015 by The Financial Risk Group, Cary, NC, USA.
*-------------------------------------------------------------*/
%macro Drawdown_Deviation(returns,
							method= DISCRETE,
							dateColumn= DATE,
							outData= DD_dev);
...
data &outData (drop= &i _type_ _freq_ &dateColumn);
	set &stat_sum &stat_n;
